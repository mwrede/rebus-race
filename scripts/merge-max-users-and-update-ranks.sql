-- Merge two "max" users and update ranks based on submissions
-- This script finds all users with username "max" (case-insensitive), merges them into one,
-- and recalculates all user ranks based on current submissions
...
-- Step 5: Recalculate ranks for all users based on submissions
